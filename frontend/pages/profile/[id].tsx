...
const ProfilePage: NextPage<ProfilePage> = ({
  ...
  const userPosts = posts && user && posts.filter(post => post.user.id === user.id)
  const [postList, setPostList] = useState(posts)

  const isOwnProfile = userData && id && Number(id ?? 0) === userData.id
          ...
          <div>
            ...
            <div className='d-flex align-start'>
              ...
              >
                ...
                <UsersFollowInfo userId={user.id} followers={followers} following={following} />
              </Paper>
            </div>
          </div>
        )}
